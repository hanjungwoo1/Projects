...
c1_train = np.loadtxt(fname = "data2/c_train1.txt", dtype=str, delimiter=' ')
x1_train = np.loadtxt(fname = "data2/x_train1.txt", dtype=str, delimiter=' ')
y1_train = np.loadtxt(fname = "data2/y_train1.txt", dtype=str, delimiter=' ')
z1_train = np.loadtxt(fname = "data2/z_train1.txt", dtype=str, delimiter=' ')
s1_train = np.loadtxt(fname = "data2/s_train1.txt", dtype=str, delimiter=' ')

c1_test = np.loadtxt(fname = "data2/c_test1.txt", dtype=str, delimiter=' ')
x1_test = np.loadtxt(fname = "data2/x_test1.txt", dtype=str, delimiter=' ')
y1_test = np.loadtxt(fname = "data2/y_test1.txt", dtype=str, delimiter=' ')
z1_test = np.loadtxt(fname = "data2/z_test1.txt", dtype=str, delimiter=' ')
s1_test = np.loadtxt(fname = "data2/s_test1.txt", dtype=str, delimiter=' ')

c2_train = np.loadtxt(fname = "data2/c_train2.txt", dtype=str, delimiter=' ')
x2_train = np.loadtxt(fname = "data2/x_train2.txt", dtype=str, delimiter=' ')
y2_train = np.loadtxt(fname = "data2/y_train2.txt", dtype=str, delimiter=' ')
z2_train = np.loadtxt(fname = "data2/z_train2.txt", dtype=str, delimiter=' ')
s2_train = np.loadtxt(fname = "data2/s_train2.txt", dtype=str, delimiter=' ')

c2_test = np.loadtxt(fname = "data2/c_test2.txt", dtype=str, delimiter=' ')
x2_test = np.loadtxt(fname = "data2/x_test2.txt", dtype=str, delimiter=' ')
y2_test = np.loadtxt(fname = "data2/y_test2.txt", dtype=str, delimiter=' ')
z2_test = np.loadtxt(fname = "data2/z_test2.txt", dtype=str, delimiter=' ')
s2_test = np.loadtxt(fname = "data2/s_test2.txt", dtype=str, delimiter=' ')

c3_train = np.loadtxt(fname = "data2/c_train3.txt", dtype=str, delimiter=' ')
x3_train = np.loadtxt(fname = "data2/x_train3.txt", dtype=str, delimiter=' ')
y3_train = np.loadtxt(fname = "data2/y_train3.txt", dtype=str, delimiter=' ')
z3_train = np.loadtxt(fname = "data2/z_train3.txt", dtype=str, delimiter=' ')
s3_train = np.loadtxt(fname = "data2/s_train3.txt", dtype=str, delimiter=' ')

c3_test = np.loadtxt(fname = "data2/c_test3.txt", dtype=str, delimiter=' ')
x3_test = np.loadtxt(fname = "data2/x_test3.txt", dtype=str, delimiter=' ')
y3_test = np.loadtxt(fname = "data2/y_test3.txt", dtype=str, delimiter=' ')
z3_test = np.loadtxt(fname = "data2/z_test3.txt", dtype=str, delimiter=' ')
s3_test = np.loadtxt(fname = "data2/s_test3.txt", dtype=str, delimiter=' ')
...
Input_shape_c = Input(shape=(input_size, 1))
...
c_train = c_train.reshape(c_train.shape[0], input_size, 1)
c_test = c_test.reshape(c_test.shape[0], input_size, 1)
...
layer1 = Conv1D(32, 4, activation='relu')(Input_shape_c)
layer1 = BatchNormalization()(layer1)
layer1 = Conv1D(32, 4, activation='relu')(layer1)
layer1 = BatchNormalization()(layer1)
layer1_out = AveragePooling1D(pool_size=2)(layer1)
...
layer = concatenate([layer1_out, layer2_out, layer3_out, layer4_out])
print(layer.shape)
layer = Reshape((47, 128, 1))(layer)
...
for i in range(1, 41):
    ...
    f = open('report/new21_' + str(i) + "_score.txt", 'w')
    f.write(str(score[1]))
    f.close()
    print(str(i) + 'end')
...
f = open('report/new21_classificaiton_report.txt', 'w')
f.write(result)
f.close()
...
for k in range(1,6):
    ...
    f = open('report/new21_' + str(k) + "_range_accuracy.txt", 'w')
    f.write(result)
    f.close()
print("==Range== end")
...
for i in range(1,41):
    name = "report/new21_" + str(i) + "_score.txt"
...
plt.legend()
plt.savefig('result/new21_acc_last.png', dpi=300)
plt.show()
