...
#c1_train = np.loadtxt(fname = "data/c_train1.txt", dtype=str, delimiter=' ')
x1_train = np.loadtxt(fname = "data/x_train1.txt", dtype=str, delimiter=' ')
y1_train = np.loadtxt(fname = "data/y_train1.txt", dtype=str, delimiter=' ')
z1_train = np.loadtxt(fname = "data/z_train1.txt", dtype=str, delimiter=' ')
s1_train = np.loadtxt(fname = "data/s_train1.txt", dtype=str, delimiter=' ')
print("1")
#c1_test = np.loadtxt(fname = "data/c_test1.txt", dtype=str, delimiter=' ')
x1_test = np.loadtxt(fname = "data/x_test1.txt", dtype=str, delimiter=' ')
y1_test = np.loadtxt(fname = "data/y_test1.txt", dtype=str, delimiter=' ')
z1_test = np.loadtxt(fname = "data/z_test1.txt", dtype=str, delimiter=' ')
s1_test = np.loadtxt(fname = "data/s_test1.txt", dtype=str, delimiter=' ')
print("2")
#c2_train = np.loadtxt(fname = "data/c_train2.txt", dtype=str, delimiter=' ')
x2_train = np.loadtxt(fname = "data/x_train2.txt", dtype=str, delimiter=' ')
y2_train = np.loadtxt(fname = "data/y_train2.txt", dtype=str, delimiter=' ')
z2_train = np.loadtxt(fname = "data/z_train2.txt", dtype=str, delimiter=' ')
s2_train = np.loadtxt(fname = "data/s_train2.txt", dtype=str, delimiter=' ')
print("3")
#c2_test = np.loadtxt(fname = "data/c_test2.txt", dtype=str, delimiter=' ')
x2_test = np.loadtxt(fname = "data/x_test2.txt", dtype=str, delimiter=' ')
y2_test = np.loadtxt(fname = "data/y_test2.txt", dtype=str, delimiter=' ')
z2_test = np.loadtxt(fname = "data/z_test2.txt", dtype=str, delimiter=' ')
s2_test = np.loadtxt(fname = "data/s_test2.txt", dtype=str, delimiter=' ')
print("4")
#c3_train = np.loadtxt(fname = "data/c_train3.txt", dtype=str, delimiter=' ')
x3_train = np.loadtxt(fname = "data/x_train3.txt", dtype=str, delimiter=' ')
y3_train = np.loadtxt(fname = "data/y_train3.txt", dtype=str, delimiter=' ')
z3_train = np.loadtxt(fname = "data/z_train3.txt", dtype=str, delimiter=' ')
s3_train = np.loadtxt(fname = "data/s_train3.txt", dtype=str, delimiter=' ')
print("5")
#c3_test = np.loadtxt(fname = "data/c_test3.txt", dtype=str, delimiter=' ')
x3_test = np.loadtxt(fname = "data/x_test3.txt", dtype=str, delimiter=' ')
y3_test = np.loadtxt(fname = "data/y_test3.txt", dtype=str, delimiter=' ')
z3_test = np.loadtxt(fname = "data/z_test3.txt", dtype=str, delimiter=' ')
s3_test = np.loadtxt(fname = "data/s_test3.txt", dtype=str, delimiter=' ')
print("6")
#### 
...
model = Model(inputs=[Input_shape_x, Input_shape_y, Input_shape_z], outputs=out)
...
for i in range(1, 41):
    ...
    model.fit([x_train, y_train, z_train], s_train, batch_size=batch_size, epochs=epochs, verbose=1)
    score = model.evaluate([x_test, y_test, z_test], s_test, verbose=0)
...
s_pred = np.argmax(model.predict([x_test, y_test, z_test]), axis=1)
